...
const CreateContactService = ({ name, number, email = "", sex, target, zipCode, availability, insurance, caseDescription, typeTreatment, stage, answered, extraInfo = [] }) => __awaiter(void 0, void 0, void 0, function* () {
