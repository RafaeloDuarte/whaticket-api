...
exports.store = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    newContact.extraInfo = extraInfo;
    ...
    const profilePicUrl = yield GetProfilePicUrl_1.default(newContact.number);
    const contact = yield CreateContactService_1.default(Object.assign(Object.assign({}, newContact), { profilePicUrl }));
